...
import { integrationUpsertShiftAssignments } from "@/src/services/integrationShiftAssignments.service";
...
export async function POST(req: NextRequest) {
  ...
  const endpoint = "/api/integration/v1/shift-assignments/upsert";
  const res = await integrationUpsertShiftAssignments(
    {
