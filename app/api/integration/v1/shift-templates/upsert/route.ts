...
import { integrationUpsertShiftTemplates } from "@/src/services/integrationShiftTemplates.service";
...
export async function POST(req: NextRequest) {
  ...
  const endpoint = "/api/integration/v1/shift-templates/upsert";
  const res = await integrationUpsertShiftTemplates(
    {
